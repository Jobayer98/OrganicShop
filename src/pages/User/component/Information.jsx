  ...
  return (
    <div className="border-t-2 border-[#7eb693] shadow-md rounded bg-white max-w-2xl">
      <form>
        ...
        <div className="p-4 pl-8 border-t mt-3">
        ...
        <div>
          <div className="p-4 pl-8">
            <span className="">
              ...
              <input
                className="border bg-slate-50 w-[50%] outline-none p-4 rounded-md text-sm"
                type="text"
                id="name"
                value={user.name}
              />
            ...
            <span>
              <label className="block mt-6 mb-2" htmlFor="email">
                Email
              </label>
              <input
                className="border bg-slate-50 w-[50%] outline-none p-4 rounded-md text-sm"
        ...
        <div className="border-t mt-3 pb-4">
          ...
          <div className="p-4 pl-8">
            <span>
              ...
              <input
                className="border bg-slate-50 w-[50%] outline-none p-3 rounded-md text-sm mb-4"
                type="password"
              />
            </span>
            <span>
              ...
              <input
                className="border bg-slate-50 w-[50%] outline-none p-3 rounded-md text-sm"
                type="password"
              />
            </span>
          </div>
